import 'package:jakojast/hooks_v2.dart';
import 'package:jakojast/main.dart' as jakojast;
...
Future<void> main() async {
  ...
  return jakojast.main("assets/configurations/configurations.json", hooksMap);
}
