...
import 'package:jakojast/files/icons/cupertino_icons.dart';
import 'package:jakojast/files/icons/material_icons.dart';
import 'package:jakojast/models/sort_first_by_item.dart';
import 'package:jakojast/models/form_related/houzi_form_page.dart';
import 'package:jakojast/models/navbar_item.dart';
...
import 'package:jakojast/l10n/string_extension.dart';
import 'package:jakojast/models/article.dart';
import 'package:jakojast/models/drawer.dart';
import 'package:jakojast/models/home_config.dart';
import 'package:jakojast/models/property_detail_page_config.dart';
...
import 'package:jakojast/pages/property_details_page.dart';
...
class UtilityMethods{
  ...
  static String formatPrice(String inputPrice, String pricePrefix){
    ...
    String postfix = '';
    String additionalCharacter = '';
    String defaultCurrency = HiveStorageManager.readDefaultCurrencyInfoData() ?? 'تومان';
    RegExp pattern = RegExp(r"\b(\d+(\.\d+)?)(M|K)\b");
    // print('1. Input Price: $inputPrice');
    /// Return Input Price If already in Compact State
    if (pattern.hasMatch(inputPrice)) {
