...
class HiveStorageManager{
  ...
  static appVersion(int app_version){
    saveData(
      key: APP_VERSION_STORE_KEY,
      data: app_version,
    );
  }

  static readVersion(){
    return readData(key: APP_VERSION_STORE_KEY);
  }

  static deleteVersion(){
    deleteData(key: APP_VERSION_STORE_KEY);
  }
