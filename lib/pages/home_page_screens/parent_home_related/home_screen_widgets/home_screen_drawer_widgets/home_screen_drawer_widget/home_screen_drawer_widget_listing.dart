...
import 'package:jakojast/pages/app_settings_pages/about.dart';
import 'package:jakojast/pages/app_settings_pages/dark_mode_setting.dart';
import 'package:jakojast/pages/app_settings_pages/language_settings.dart';
import 'package:jakojast/pages/app_settings_pages/web_page.dart';
import 'package:jakojast/pages/crm_pages/crm_activities/activities_from_board.dart';
import 'package:jakojast/pages/crm_pages/crm_bottom_bar.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/add_property_request.dart';
import 'package:jakojast/pages/crm_pages/crm_deals/deals_from_board.dart';
import 'package:jakojast/pages/crm_pages/crm_inquiry/inquiries_from_board.dart';
import 'package:jakojast/pages/crm_pages/crm_leads/leads_from_board.dart';
import 'package:jakojast/pages/home_page_screens/parent_home_related/home_screen_widgets/home_screen_drawer_widgets/home_screen_drawer_widget/home_screen_drawer_list_tile.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/all_agency.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/all_agents.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/favorites.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/my_agency_agents.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/properties.dart';
import 'package:jakojast/pages/quick_add_property/quick_add_property.dart';
...
import 'package:jakojast/pages/quick_add_property/quick_add_property_v2.dart';
