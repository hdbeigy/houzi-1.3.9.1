...
import 'package:jakojast/pages/home_screen_drawer_menu_pages/user_related/user_forget_password.dart';
import 'package:jakojast/pages/home_screen_drawer_menu_pages/user_related/user_signup.dart';
import 'package:jakojast/pages/main_screen_pages/my_home_page.dart';
import 'package:jakojast/utils/platform_helper.dart';
...
import 'package:jakojast/widgets/generic_link_widget.dart';
...
import 'package:jakojast/widgets/user_sign_in_widgets/social_sign_on_widgets.dart';
...
class UserSignInState extends State<UserSignIn> with ValidationMixin {
  ...
  isiOSSignInAvailable() async {
    ...
    if (PlatformHelper.isIOS && SHOW_LOGIN_WITH_APPLE && isAvailable) {
