...
import 'package:jakojast/pages/add_Property_Pages/property_address.dart';
import 'package:jakojast/pages/add_Property_Pages/property_details.dart';
import 'package:jakojast/pages/add_Property_Pages/property_features.dart';
import 'package:jakojast/pages/add_Property_Pages/property_floorPlans.dart';
import 'package:jakojast/pages/add_Property_Pages/property_media.dart';
import 'package:jakojast/pages/add_Property_Pages/property_settings.dart';
import 'package:jakojast/pages/add_property_pages/property_contact_information.dart';
import 'package:jakojast/pages/add_property_pages/property_gdpr_agreement.dart';
import 'package:jakojast/pages/add_property_pages/property_information.dart';
import 'package:jakojast/pages/add_property_pages/property_private_note.dart';
import 'package:jakojast/pages/add_property_pages/property_sub_listing.dart';
import 'package:jakojast/pages/add_property_pages/property_virtual_tour_link.dart';
...
import 'package:jakojast/widgets/light_button_widget.dart';
...
class AddPropertyState extends State<AddProperty> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    _defaultCurrency = HiveStorageManager.readDefaultCurrencyInfoData() ?? 'تومان';
